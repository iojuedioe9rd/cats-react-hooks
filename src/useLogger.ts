...
export class Logger {
  ...
  public log(...message: any) {
    console.log(
      `${colours.fg.gray}[${this.loggerConfig.namespace}]: ${message}`,
    );
  }

  public error(...message: any) {
    console.error(
      `${colours.fg.red}[${this.loggerConfig.namespace}]: ${message}`,
    );
  }

  public warning(...message: any) {
    console.warn(
      `${colours.fg.yellow}[${this.loggerConfig.namespace}]: ${message}`,
    );
  }
}
